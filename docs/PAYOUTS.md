...
Payout module will fetch all rows from Redis with key `vns:payments:pending` and credit balance back to miners. Usually you will have only single entry there.
...
```
ZREVRANGE "vns:payments:pending" 0 -1 WITHSCORES
```
...
```
ZADD "vns:payments:all" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:0xb85150eb365e7df0941f0cf08235f987ba91506a:25000000
```

```
ZADD "vns:payments:0xb85150eb365e7df0941f0cf08235f987ba91506a" 1462920526 0xe670ec64341771606e55d6b4ca35a1a6b75ee3d5145a99d05921026d1527331:25000000
```

### Delete Erroneous Payment Entry

```
ZREM "vns:payments:pending" "0xb85150eb365e7df0941f0cf08235f987ba91506a:25000000"
```

### Update Internal Stats

```
HINCRBY "vns:finances" pending -25000000
HINCRBY "vns:finances" paid 25000000
```

### Unlock Payouts

```
DEL "vns:payments:lock"
```
